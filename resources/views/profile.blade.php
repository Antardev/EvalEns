...
@php
$svgEye = '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16"><path d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8zM1.173 8a13.133 13.133 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5c2.12 0 3.879 1.168 5.168 2.457A13.133 13.133 0 0 1 14.828 8c-.058.087-.122.183-.195.288-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5c-2.12 0-3.879-1.168-5.168-2.457A13.134 13.134 0 0 1 1.172 8z"/><path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0z"/></svg>';
            ...
            <div class="card">
                <div class="card-body py-4 text-center">
                    ...
                    @if(session('success_avatar'))
                        <div class="alert alert-success alert-dismissible fade show mb-3 text-start fs-13">
                            <i class="lni lni-checkmark-circle me-1"></i>{{ session('success_avatar') }}
                    ...
                    <div class="position-relative d-inline-block mb-3">
                        ...
                        @else
                            <div class="d-flex align-items-center justify-content-center rounded-circle text-white fw-bold mx-auto"
                                style="width:90px;height:90px;font-size:30px;background:#2F4CDD;">
                                {{ strtoupper(substr($user->prenom, 0, 1)) }}
                            </div>
                        @endif
                        <label for="avatarInput" title="Changer la photo"
                            class="position-absolute bottom-0 end-0 btn btn-primary btn-xs rounded-circle d-flex align-items-center justify-content-center"
                            style="width:28px;height:28px;cursor:pointer;padding:0;">
                            <i class="lni lni-camera" style="font-size:13px;"></i>
                        </label>
                    </div>

                    <form id="avatarForm" method="POST" action="{{ route('profile.update-avatar') }}" enctype="multipart/form-data" class="d-none">
                        @csrf
                    ...
                    <ul class="nav nav-pills" id="profileTabs">
                        <li class="nav-item">
                            <a class="nav-link {{ $activeTab === 'info' ? 'active' : '' }}"
                                ...
                                <i class="lni lni-user me-1"></i>Informations personnelles
                            </a>
                        </li>
                        <li class="nav-item ms-2">
                            <a class="nav-link {{ $activeTab === 'password' ? 'active' : '' }}"
                                href="#tabPassword" data-bs-toggle="tab">
                                <i class="lni lni-lock me-1"></i>Mot de passe
                            </a>
                        </li>
                    </ul>
                </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <button type="button" tabindex="-1"
                                                ...
                                                onclick="togglePwd('pwdCurrent',this)">{!! $svgEye !!}</button>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <button type="button" tabindex="-1"
                                                class="btn position-absolute top-50 end-0 translate-middle-y me-2 p-0 border-0 bg-transparent text-muted"
                                                onclick="togglePwd('pwdNew',this)">{!! $svgEye !!}</button>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <button type="button" tabindex="-1"
                                                class="btn position-absolute top-50 end-0 translate-middle-y me-2 p-0 border-0 bg-transparent text-muted"
                                                onclick="togglePwd('pwdConfirm',this)">{!! $svgEye !!}</button>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary">
